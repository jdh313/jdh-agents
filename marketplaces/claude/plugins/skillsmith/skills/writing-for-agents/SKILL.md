...
description: >-
  ...
  or CLAUDE.md, a rules file, a doc reached by a pointer. Use when creating or
  editing a skill, when modifying AGENTS.md / CLAUDE.md / a rules file, or when
  the user asks how to make an agent-facing document more predictable. Adapted
