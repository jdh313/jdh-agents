...
The diagrams carry the weight. Prose is sparse, plain, and uses the glossary terms ([`../../CODEBASE-DESIGN.md`](../../CODEBASE-DESIGN.md)) without ceremony.
...
Plain English, concise — but the architectural nouns and verbs come straight from [`../../CODEBASE-DESIGN.md`](../../CODEBASE-DESIGN.md): **module**, **interface**, **depth**, **seam**, **adapter**, **leverage**, **locality**. Concision is not an excuse to drift into "component," "service," "API," or "boundary."
...
No hedging, no throat-clearing, no "it's worth noting that…". If a sentence could be a bullet, make it a bullet. If a bullet could be cut, cut it. If a term isn't in [`../../CODEBASE-DESIGN.md`](../../CODEBASE-DESIGN.md)'s glossary, reach for one that is before inventing a new one.
