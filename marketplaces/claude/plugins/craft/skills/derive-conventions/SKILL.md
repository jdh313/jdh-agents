...
when_to_use: >-
  Use when the user says "derive the conventions", "set up CONVENTIONS.md",
  "capture this repo's house style", "stop re-deriving the conventions",
  "refresh the conventions file", or after the first run of house-style-reviewer
  / comment-reviewer / copy-reviewer surfaces rules worth pinning.
