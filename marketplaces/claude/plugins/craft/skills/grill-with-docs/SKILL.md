...
description: >-
  Grill a plan against this repo's CONTEXT.md glossary and NDR atoms, sharpen
  terminology, and update CONTEXT.md inline as decisions crystallise. Use when
  stress-testing a plan against project vocabulary, locking in a domain term, or
  surfacing drift between code naming and the glossary. Adapted from
