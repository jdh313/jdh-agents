...
description: >-
  ...
  "weekly planning", or "weekly check-in". Provides a structured weekly review
  conversation that audits project attention, enforces WIP limits, and converges
  on 1-2 focus projects for the coming week.
allowed-tools:
