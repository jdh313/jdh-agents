...
name: today
description: >-
  This skill should be used when the user says "/today", "plan my day", "what
  should I focus on today", "morning planning", "daily priorities", "start my
  day", or "daily planning". Provides a structured morning check-in that
  converges on 3 priorities through an adaptive coaching conversation with
  energy-calibrated tone.
allowed-tools:
