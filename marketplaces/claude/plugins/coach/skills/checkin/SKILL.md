...
description: >-
  ...
  captures what actually happened, and writes a brief end-of-day section to the
  daily note.
when_to_use: >-
  This skill should be used when the user says "/checkin", "end of day", "how
  did today go", "daily reflection", "what did I get done", "wrap up my day", or
  "day's over".
allowed-tools:
