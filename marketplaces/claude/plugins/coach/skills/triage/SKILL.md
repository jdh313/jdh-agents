...
description: >-
  ...
  mess", "triage my tasks", or "what's overdue". Provides guilt-free batch
  processing of overdue Todoist tasks with reschedule/do/drop/delegate actions
  and ADHD-friendly framing -- these aren't failures, they're renegotiations.
allowed-tools:
