...
description: >-
  ...
  is broken/throwing/failing, or describes a performance regression. Adapted
  from mattpocock/skills (MIT, © 2026 Matt Pocock).
---
...
- [ ] The hypothesis that turned out correct is stated in the commit / PR message or captured as an NDR atom via `/capture-decision` — so the next debugger learns
