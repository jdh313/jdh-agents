...
description: >-
  Scaffold a new savings goal — a tracked plan to save toward a specific
  purchase with tier, budget, acceptance criteria, and decision triggers. Use
  when the user says "I want to save for X", "let's add a savings goal", "I'm
  planning to buy X eventually", "I should start saving for", or otherwise
  frames an upcoming substantial purchase as something needing deliberate
  funding.
---
