...
- `context/work` tag is standard for current work notes.
...
- Examples:
  - `2026-04-20 Day 1 with Stevie.md`
  - `2026-04-20 Meeting with Joni.md`
  - `2026-05-03 AcmeOS Architecture Review.md`
...
[[2026-04-20 Day 1 with Stevie]])`. The point is unambiguous: the
