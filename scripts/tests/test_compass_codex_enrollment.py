"""JUN-344, bullet 1: `compass` must compile and validate for the Codex target.
...
The enrolled count moved from seven to fourteen in JUN-352, which enrolled the
remaining catalog. `langfuse` is the one package still absent, by decision
rather than by omission — see JUN-350. The canonical enrolled set lives in
