...
- **Project folder** — relative to vault root. Examples: `Work/Projects/Atlas`, `Personal/Projects/WireViz-ng`, `Hobbies/Lighthouse Audit`.
...
- `{{PROJECT}}` → project folder leaf name (e.g. `Atlas`)
