...
The compiler baseline for this enrollment is AgentForge commit `161d0e1`
(`agentforge` 0.0.1).
...
```bash
export AGENTFORGE_PROJECT=/path/to/agentforge-at-161d0e1
...
`161d0e18774a4d6c0d65497ff7830083cd4a9424`. Since that repository is private,
