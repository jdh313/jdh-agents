...
- **`Issue refs`** — `summary` keeps a ticket key like `(TEAM-153)` / `#123` in the subject (useful when a Linear/Jira integration parses it); `pr` keeps refs out of the subject.
