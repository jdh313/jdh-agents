...
- [OrcaSlicer: VFA Calibration guide](https://www.orcaslicer.com/wiki/calibration/vfa-calib) — Speed nas1 test for identifying VFA (Vertical Fine Artifacts) hot spots in your slicer speed settings
