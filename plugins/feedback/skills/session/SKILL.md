...
description: >-
  ...
  otherwise signals the end of a session spent exercising agent plugins
  (skills, delegates, hooks) and wants a report to hand back to
  the plugin author. Analyzes ONLY the current session record, asks no
