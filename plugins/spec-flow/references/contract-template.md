...
- **Audience applies recursively and reaches working-matter at close** (`233ar3`). A cold *reviewer* reads front-matter at the review gate; a cold *closer* reads front-matter **and working-matter** at the close gate — the closer may not be the implementer. Working-matter is therefore held to a **fresh-closer legibility standard** (the atom-shaped row already meets it). Neither surface is written for a mid-flight-churn reader.
