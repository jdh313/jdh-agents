...
- **Linear host:** *"Closed TEAM-49. 2 ndr atoms created, 1 README update applied. Moved to In Review; ticket body left intact. Set it Done yourself when the PR merges."*
