...
> "Linear MCP server isn't connected — I can't read TEAM-49's description. Pause while you wire up the MCP, or close the migration steps using context held in conversation only?"
...
- **Linear host:** *"Closed TEAM-49. 2 ndr atoms created, 1 README update applied. Archive: N/A — Linear-tracked. Suggestion: flip the ticket state when you push the PR. I haven't touched it."*
