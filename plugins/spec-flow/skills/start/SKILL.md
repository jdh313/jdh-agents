...
- **Ticket token framed as the contract** (`the contract is CAR-49`, `use CAR-49`, `implement CAR-49`, or bare `CAR-49`) → **linear** host.
- **Ticket token framed as a reference** (`see CAR-49`, `regarding CAR-49`, `the work in CAR-49`, `draft a contract for CAR-49`) → **ask once**: *"Use CAR-49 itself as the contract, or draft a `.docs/` file that references it?"* Use the user's answer.
