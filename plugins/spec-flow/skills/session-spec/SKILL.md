...
- **Project folder** — relative to vault root. Examples: `Work/Projects/AcmeOS`, `Personal/Projects/WireViz-ng`, `Hobbies/Lighthouse Audit`.
...
- `{{PROJECT}}` → project folder leaf name (e.g. `AcmeOS`)
