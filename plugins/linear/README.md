...
- **Currently scoped to:** The `CAR` (Carta Healthcare) workspace. Linear is CartaOS-only — see `~/Loose Ends/Reference/Tools/Software Catalog/Linear.md`.
...
Deliberation history (why Linear was adopted, structural setup for CartaOS) lives in the vault:

- `Reference/Tools/Software Catalog/Linear.md` — catalog entry (why, when, scope)
- `Carta/Projects/CartaOS/Linear Setup.md` — structural shape (workspace, team, project granularity, milestones, labels, cycles, views)
