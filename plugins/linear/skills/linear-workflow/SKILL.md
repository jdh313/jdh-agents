...
CAR-99 and CAR-116 are the existing examples of tickets that clear the orphan bar.
...
- A `Decision` may convert to `Spike` on pickup, when making the call turns out to need evidence first (CAR-116 is the live example of this pressure).
