...
**Caught 2026-05-15** creating TEAM-5; full discussion in `~/Loose Ends/Work/Projects/AcmeOS/Linear Setup — Labels.md` under "MCP gotcha".
...
```
mcp__linear-server__save_issue({id: "TEAM-37", estimate: 5})
...
```
mcp__linear-server__save_issue({id: "TEAM-43", duplicateOf: "TEAM-83"})
...
**Caught 2026-05-29** while merging TEAM-43 into TEAM-83 during a Linear backlog grooming pass.
...
```
mcp__linear-server__save_issue({id: "TEAM-66", project: ""})
