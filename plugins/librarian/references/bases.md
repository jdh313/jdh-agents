...
|---------|----------------|-----|
| Working on a repo | Prince Repos | Find repo notes, patterns |
...
**Prince Repos** (`Bases/Prince Repos.base`)
- Filter: `file.inFolder("Prince/Repos")`
- Properties: github-url, used-in, uses, status
- Use: Repository documentation

**ADRs** (`Bases/ADRs.base`)
- Filter: `file.folder == "Prince/Decisions"` OR `tags contains "type/adr"`
