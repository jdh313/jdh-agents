...
|---|---|---|---|
| "00:05 Andrew: non-free Zoom for >40min calls" | [[People/Andrew Crowder]] | ## Onboarding notes | minor — consider skipping |
...
```markdown
[^2026-04-21-greg]: Per [[Greg Bean]] in [[Carta/Meetings/2026-04-21 Intro with Greg Bean]] (transcript [[Sources/2026-04-21 Transcript — Intro with Greg Bean]]).
```
...
```yaml
transcript: "[[Sources/2026-04-21 Transcript — Intro with Greg Bean]]"
```
...
- **Relay upgrades.** Transcript may reveal the cited speaker was relaying someone else. Keep person-in-the-room as the footnote attribution (main workflow rule), but surface the relay in body: "Per [[Greg]] (relaying [[Chris]]): …"
