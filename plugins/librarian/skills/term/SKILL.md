---
name: term
description: Name the precise term for what you were fumbling to say, rewrite your sentence with it, and log it to your vault word log
disable-model-invocation: true
argument-hint: "[what you were trying to say]"
allowed-tools:
  - Bash(git rev-parse *)
---
