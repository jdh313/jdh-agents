...
>
> - **Current state:** untested; first real test is the CartaOS 184-ref backfill
...
>
> - **Current state:** no known collisions in CartaOS
...
- The CartaOS 184-ref backfill becomes a triage: each ref classified as id / slug / topic.
