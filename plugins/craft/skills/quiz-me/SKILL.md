---
name: quiz-me
description: Opt-in active-recall comprehension check on code or a concept just
  explained. Predict-then-verify, one question at a time, pitched at the why and
  the mental model rather than syntax recall.
