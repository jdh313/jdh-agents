---
name: grill
description: Grill the user relentlessly about a plan, decision, or idea — one question at a time, walking the design tree until you reach a shared understanding. Use when the user says "grill me", "grill this", "grill me on this plan", or asks to be interviewed hard about something before acting on it. Adapted from mattpocock/skills (MIT, © 2026 Matt Pocock).
upstream:
  repo: mattpocock/skills
  path: skills/productivity/grilling
  reviewed_sha: 85f83d3fde1d
  reviewed: 2026-08-29
  status: reviewed
allowed-tools:
  - Read
