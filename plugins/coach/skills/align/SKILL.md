...
description: >-
  ...
  projects", "goal to project mapping", "which of my projects help with
  [X]", "what existing projects support [goal]", "am I working on the
  right things", or "focus my projects on [goal]". Scans Linear projects
  and Obsidian project/hobby notes to map existing work to a stated goal,
  recommending focus order and identifying gaps.
allowed-tools:
  # Linear — scan projects and initiatives
