...
name: momentum
description: >-
  Use this agent when the user asks "what patterns do you see", "show me my
  trends", "momentum check", "am I making progress", "what have I been
  focusing on", "focus history", "where does my time go", "pattern analysis",
  or "what's my trajectory". Analyzes historical coaching notes from Obsidian
