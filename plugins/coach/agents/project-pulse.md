...
name: project-pulse
description: >-
  Use this agent when the user asks "what projects have I neglected?",
  "stale projects", "project health check", "audit my projects",
  "which projects need attention", or "what's been dormant". Scans
