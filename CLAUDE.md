...
- Committed generated native manifests for all nineteen Claude packages and the fifteen Codex-enrolled ones
...
│   ├── claude/                   # Complete Claude marketplace root (19 packages)
